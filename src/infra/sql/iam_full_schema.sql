...
GO
/****** Object:  User [saa]    Script Date: 1/10/2026 8:43:57 AM ******/
CREATE USER [saa] FOR LOGIN [saa] WITH DEFAULT_SCHEMA=[saa]
GO
/****** Object:  Schema [audit]    Script Date: 1/10/2026 8:43:57 AM ******/
CREATE SCHEMA [audit]
GO
/****** Object:  Schema [iam]    Script Date: 1/10/2026 8:43:57 AM ******/
CREATE SCHEMA [iam]
GO
/****** Object:  Schema [saa]    Script Date: 1/10/2026 8:43:57 AM ******/
CREATE SCHEMA [saa]
GO
/****** Object:  Table [iam].[GrantScopes]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [iam].[MembershipEffectivePermissions]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[MembershipPermissionOverrides]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[MembershipRoles]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Memberships]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Permissions]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[RefreshTokens]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Resources]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[ResourceTypes]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[RolePermissionGrants]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Roles]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[UserCredentials]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Users]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[WidgetConversationReads]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [iam].[WidgetConversationReads](
 ...
 CONSTRAINT [PK_WidgetConversationReads] PRIMARY KEY CLUSTERED 
(
	[ReadKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [UK_WidgetConversationReads_Conversation_User] UNIQUE NONCLUSTERED 
(
	[ConversationKey] ASC,
	[UserKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [iam].[WidgetConversations]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [iam].[WidgetConversations](
	...
	[LastMessageMongoId] [nvarchar](100) NULL,
	[MessageCount] [int] NOT NULL,
	[VisitorMessageCount] [int] NOT NULL,
...
GO
/****** Object:  Table [iam].[WidgetMessages]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[Widgets]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [iam].[WorkspaceInvites]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [iam].[WorkspaceInvites](
 ...
 CONSTRAINT [PK_WorkspaceInvites] PRIMARY KEY CLUSTERED 
(
	[InviteKey] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [UQ_WorkspaceInvites_InviteId] UNIQUE NONCLUSTERED 
(
	[InviteId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [UQ_WorkspaceInvites_TokenHash] UNIQUE NONCLUSTERED 
(
	[TokenHash] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [iam].[Workspaces]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [iam].[WidgetConversationReads] ADD  DEFAULT ((0)) FOR [LastReadVisitorCount]
GO
ALTER TABLE [iam].[WidgetConversationReads] ADD  DEFAULT (sysutcdatetime()) FOR [LastReadAt]
GO
...
GO
ALTER TABLE [iam].[WidgetConversations] ADD  CONSTRAINT [DF_iam_WidgetConversations_MessageCount]  DEFAULT ((0)) FOR [MessageCount]
GO
ALTER TABLE [iam].[WidgetConversations] ADD  DEFAULT ((0)) FOR [VisitorMessageCount]
GO
...
GO
ALTER TABLE [iam].[WorkspaceInvites] ADD  DEFAULT (newsequentialid()) FOR [InviteId]
GO
ALTER TABLE [iam].[WorkspaceInvites] ADD  DEFAULT ((1)) FOR [Status]
GO
ALTER TABLE [iam].[WorkspaceInvites] ADD  DEFAULT (sysutcdatetime()) FOR [CreatedAt]
GO
...
GO
ALTER TABLE [iam].[Workspaces] ADD  CONSTRAINT [DF_iam_Workspaces_UpdatedAt]  DEFAULT (sysutcdatetime()) FOR [UpdatedAt]
GO
...
GO
ALTER TABLE [iam].[WorkspaceInvites]  WITH CHECK ADD  CONSTRAINT [FK_WorkspaceInvites_InvitedBy] FOREIGN KEY([InvitedByMembershipKey])
REFERENCES [iam].[Memberships] ([MembershipKey])
GO
ALTER TABLE [iam].[WorkspaceInvites] CHECK CONSTRAINT [FK_WorkspaceInvites_InvitedBy]
GO
ALTER TABLE [iam].[WorkspaceInvites]  WITH CHECK ADD  CONSTRAINT [FK_WorkspaceInvites_Workspace] FOREIGN KEY([WorkspaceKey])
REFERENCES [iam].[Workspaces] ([WorkspaceKey])
GO
ALTER TABLE [iam].[WorkspaceInvites] CHECK CONSTRAINT [FK_WorkspaceInvites_Workspace]
GO
...
GO
ALTER TABLE [iam].[WorkspaceInvites]  WITH CHECK ADD  CONSTRAINT [CK_WorkspaceInvites_Status] CHECK  (([Status]=(4) OR [Status]=(3) OR [Status]=(2) OR [Status]=(1)))
GO
ALTER TABLE [iam].[WorkspaceInvites] CHECK CONSTRAINT [CK_WorkspaceInvites_Status]
GO
...
GO
/****** Object:  StoredProcedure [iam].[RebuildMembershipEffectivePermissions]    Script Date: 1/10/2026 8:43:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
